    ...
    <div className="hidden md:flex fixed inset-0 bg-black/80 backdrop-blur-sm z-50 items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="text-center mb-2 md:mb-2">
          <h2 className="text-xl md:text-2xl lg:text-4xl font-bold text-white">Mejores Casas de Apuestas en México</h2>
        </div>
        ...
        <div className="text-center mt-4 md:mt-8">
          <p className="text-white text-xs md:text-sm">
            +18. Aplican T&C. Operadores regulados por <span className="underline">SEGOB</span>. Juega con responsabilidad.
          </p>
        </div>
      </div>
    </div>
